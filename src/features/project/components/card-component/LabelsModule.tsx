...
const LabelsModule: React.FC<LabelsModuleProps> = ({
  ...
  return (
    <div className='module-content flex'>
      <div className='flex h-[2rem] w-full flex-wrap gap-2'>
      ...
      {showDialog && (
        <div className='bg-opacity-50 fixed inset-0 z-10 flex items-center justify-center'>
              ...
              {editingLabelIndex !== null && (
                <button
                  ...
                  onClick={() => {
                    ...
                    onChange(
                      updatedLabels,
                      `delete Label:${labels[editingLabelIndex].text}`
                    )
                    setShowDialog(false)
                    setEditingLabelIndex(null)
                  }}
